...
export default class PackageManager {
    constructor() {
        ...
        // Core package is preloaded
        this.loadPackage('core', require('../commands/coreCommandPackage'));
    }

    /**
     * Loads and enables a package.
     * @todo Document how packages work
     * @param  {[type]} name The name of the package to register it under. Must be unique.
     * @param  {[type]} pkg  The package itself. Must either be an object or a function that returns an object.
     */
